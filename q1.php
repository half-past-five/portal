...
<body>
	...
	//Read Query
	$tsql= "SELECT [ID], [Last Name], [First Name], [E-mail Address], [Job Title], [City]  FROM [L8-Employees] ORDER BY [Last Name], [First Name]";
	...
	*/
	...
	<form method="post"> 
		...
		<input type="submit" value="Menu" formaction="auth.php">
	</form> 
