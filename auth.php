...
<body>
	...
	if (empty($_GET["username"])) echo "Username is empty!<br/>";
	if (empty($_GET["password"])) echo "Password is empty!<br/>";
	echo "Executing query: " . $tsql . ") with Username: " . $_GET["username"] . "<br/>";
